...
void init_bn382_params()
{
    ...
    bn382_Fq::nqr_to_t = bn382_Fq("926642806721114476368757157645289729546034110359000734340680542302430854664018239532699015859941333394840267162320"); // TODO: DITTO

    /* additional parameters for square roots in Fq/Fq2 */
    bn382_coeff_b = bn::Fp(3);                  // TODO
    bn382_Fq_s = 1;                             // TODO
    bn382_Fq_nqr_to_t = bn::Fp("21888242871839275222246405745257275088696311157297823662689037894645226208582");            // TODO
    bn382_Fq_t_minus_1_over_2 = mie::Vuint("5472060717959818805561601436314318772174077789324455915672259473661306552145"); // TODO

    bn382_twist_coeff_b = bn::Fp2(bn::Fp("19485874751759354771024239261021720505790618469301721065564631296452457478373"),  // TODO
                                  bn::Fp("266929791119991161246907387137283842545076965332900288569378510910307636690"));   // TODO
    bn382_Fq2_s = 4;
