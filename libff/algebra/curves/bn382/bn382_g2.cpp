...
bn::Fp2 bn382_G2::sqrt(const bn::Fp2 &el)
{
    size_t v = bn382_Fq2_s;
    bn::Fp2 z = bn382_Fq2_nqr_to_t;
    bn::Fp2 w = mie::power(el, bn382_Fq2_t_minus_1_over_2);
    bn::Fp2 x = el * w;
    bn::Fp2 b = x * w;
...
std::istream& operator>>(std::istream &in, bn382_G2 &g)
{
    ...
    if (!is_zero)
    {
        ...
        bn::Fp2::add(tY2, tY2, bn382_twist_coeff_b);

        g.coord[1] = bn382_G2::sqrt(tY2);
